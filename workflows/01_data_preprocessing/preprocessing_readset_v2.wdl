...
## 修复版 Read Set 预处理工作流 v2
## 使用AWS Omics兼容的ECR镜像

workflow PreprocessingWorkflowReadSetV2 {
    meta {
        description: "修复版测序数据预处理工作流v2"
        version: "2.0"
