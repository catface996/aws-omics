...
## 修复版 Read Set 预处理工作流 v4
## 使用正确的ECR镜像URI格式

workflow PreprocessingWorkflowReadSetV4 {
    meta {
        description: "修复版测序数据预处理工作流v4 - ECR镜像URI修复"
        version: "4.0"
